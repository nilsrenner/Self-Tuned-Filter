...
% option argument of caption suppress citation hyperlink in table of contents by using \CiteNolink rather than \cite
\caption[Caption text\label{example-image-b}~\CiteNolink{GSL}.]{Caption text\label{example-image-b}~\cite{GSL}.}
\end{figure}
...
%%%%%%%%%%%%%%% begin table %%%%%%%%%%%%%%%%%% 
\begin{table}[t]
\caption{The error function and complementary error function\label{tab:1}}\vspace{0.5em}
\centering{%
